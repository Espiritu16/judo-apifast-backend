...
def actualizar_parametros(id_producto: int, payload: ParametroInventarioUpdate, db: Session = Depends(get_db), user: Usuario = Depends(require_roles('DUEÑA', 'EMPLEADO'))):
    return respuesta_ok(
